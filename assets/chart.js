import { clipPoints, formatRating, pointTime, samplePoints } from "./state.js?v=074854fc008a";
import { t } from "./i18n.js?v=074854fc008a";

import { englishPlayerName, setPlayerName } from "./player-display.js?v=074854fc008a";
  ...
  render(series, options = {}) {
    ...
    clipped.forEach((item) => {
      ...
      hit.addEventListener("pointermove", (event) => {
        ...
        const strong = document.createElement("strong"); setPlayerName(strong, item);
        ...
        match.title = englishPlayerName(point, "opponent_name");
